...
sudo iptables -t nat -A POSTROUTING -p tcp --match multiport --dports  80,443,2082 -j MASQUERADE 
sudo iptables -t nat -A PREROUTING -p tcp --match multiport --dports  80,443,2082 -j DNAT --to-destination $IP
